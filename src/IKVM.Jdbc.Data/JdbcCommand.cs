...
namespace IKVM.Jdbc.Data
{
    ...
    /// <summary>
    /// Describes a command to be executed against a JDBC connection.
    /// </summary>
    public class JdbcCommand : DbCommand
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="DbTransaction"/> within which this <see cref="JdbcCommand"/> object executes.
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public JdbcParameter CreateJdbcParameter()
        {
            if (prepared != null)
